                    ...
                    <ul className="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
                        <li className="nav-item">
                            <a href="#submenu0" className="nav-link align-middle px-0" onClick={() => handleSubMenuClick('home')}>
                                <i className="fs-4 bi-house"></i> <span className="ms-1 d-none d-sm-inline">{t("mngGuide")}</span>
                            </a>
                        </li>
                        <li>
                            <a href="#submenu2" className="nav-link px-0 align-middle" onClick={() => handleSubMenuClick('picos')}>
                                <i className="fs-4 bi-grid"></i> <span className="ms-1 d-none d-sm-inline" >{t("Pizzas")}</span> 
                            </a>
                        </li>
                        <li>
                            <a href="#submenu3" className="nav-link px-0 align-middle">
                                <i className="fs-4 bi-grid"></i> <span className="ms-1 d-none d-sm-inline"onClick={() => handleSubMenuClick('products')}>{t("Products")}</span> 
                            </a>
                        </li>
                        <li>
                            <a href="#" className="nav-link px-0 align-middle" onClick={() => handleSubMenuClick('orders')}>
                                <i className="fs-4 bi-table"></i> <span className="ms-1 d-none d-sm-inline">{t("Orders")}</span>
                            </a>
                        </li>
                    </ul>
                </div>
