  ...
  return (
    <>
      ...
      <div className="instructionButtons">
        <button
          type="button"
          className="btn btn-outline-secondary instructionButton"
      ...
      <div className="col py-3 manager">
        {activeSubMenu === "pizzas" && <div>Picos</div>}
        {activeSubMenu === "products" && <div>Produktai</div>}

        {activeSubMenu === "orders" && <div>Užsakymai</div>}
      </div>
    </>
  );
}
