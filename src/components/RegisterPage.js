        ...
        <section style={{maxWidth:"24em"}}>
            ...
            <form onSubmit={handleSubmit}>
                ...
                <label htmlFor="username">
                    ...
                    <span style={{ display: validName ? "" : "none" }}>
                        ✅
                    </span>
                </label>
                <input
                ...
                />
                <span id="uidnote" style={{ display: userFocus && user && !validName ? "block" : "none" }}>
                ...
                <label htmlFor="name">
                    ...
                    <span style={{ display: validFirstname ? "" : "none" }}>
                        ✅
                    </span>
                </label>
                <input
                ...
                />
                <span id="fnidnote" style={{ display: firstname && !validFirstname && firstnameFocus ? "" : "none" }}>
                ...
                <label htmlFor="lastname">
                    ...
                    <span style={{ display: validLastname ? "" : "none" }}>
                        ✅
                    </span>
                </label>
                <input
                ...
                />
                <span id="lnidnote" style={{ display: lastname && !validLastname && lastnameFocus ? "" : "none" }}>
                ...
                <label htmlFor="email">
                    ...
                    <span style={{display: validEmail ? "" : "none" }}>
                        ✅
                    </span>
                </label>
                <input
                ...
                />
                <span id="emailnote" style={{ display: emailFocus && email && !validEmail ? "block" : "none" }}>
                ❗Please enter a propper email</span>
                ...
                {t("Password")}:
                    ...
                    <span style={{ display: validPwd ? "" : "none" }}>
                        ✅
                    </span>
                </label>
                <input
                ...
                />
                <span id="pwdnote" style={{ display: pwdFocus && !validPwd ? "" : "none"}}>
                    ❗
                ...
                <input
                    ...
                    className="p_input-field"
                />
                <span id="confirmnote" style={{ display: matchFocus && !validMatch ? "" : "none"}}>
                    ❗
